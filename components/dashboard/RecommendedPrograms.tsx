...
const programs = [
  ...
  {
    id: '2',
    name: 'Intermédiaire - Haltères',
    duration: '8 semaines',
    level: 'Intermédiaire',
    equipment: 'Haltères',
    description: 'Développe ta force et ton endurance sur des mouvements avec haltères.',
  ...
  },
  {
    ...
    level: 'Avancé',
    equipment: 'Machines de salle',
    description: 'Optimise ta puissance en combinant circuits machines et charges contrôlées.',
  ...
  },
  {
    ...
    level: 'Avancé',
    equipment: 'Barres',
    description: 'Programme de force centrale avec la barre olympique et les charges libres.',
