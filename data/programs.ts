...
const rawPrograms: Omit<Program, 'slug'>[] = [
  ...
  },
  {
    ...
    description: 'Travail complet avec haltères pour augmenter ta force fonctionnelle.',
    exercises: 26,
    ...
    sessions: [
      {
        id: '2-a',
        name: 'Jour 1 - Full body haltères',
        focus: 'Mouvement multi-articulaires',
        duration: 40,
        exercises: [
          { name: 'Goblet squat', sets: 4, reps: 10, rest: 60 },
          { name: 'Développé couché haltères', sets: 3, reps: 10, rest: 60 },
          { name: 'Rowing haltère un bras', sets: 3, reps: 12, rest: 60 },
          { name: 'Fentes marchées haltères', sets: 3, reps: 12, rest: 60 },
          { name: 'Planche avec haltère', sets: 3, reps: 30, rest: 45 },
        ],
      },
      {
        id: '2-b',
        name: 'Jour 2 - Push & épaules',
        focus: 'Développé',
        duration: 38,
        exercises: [
          { name: 'Développé militaire haltères', sets: 4, reps: 8, rest: 60 },
          { name: 'Incline press haltères', sets: 3, reps: 10, rest: 60 },
          { name: 'Élévations latérales', sets: 3, reps: 12, rest: 45 },
          { name: 'Dips sur banc', sets: 3, reps: 12, rest: 45 },
          { name: 'Pompes pieds surélevés', sets: 3, reps: 15, rest: 45 },
        ],
      },
      {
        id: '2-c',
        name: 'Jour 3 - Pull & hanche',
        focus: 'Dos et chaîne postérieure',
        duration: 42,
        exercises: [
          { name: 'Soulevé de terre jambes tendues', sets: 4, reps: 10, rest: 60 },
          { name: 'Rowing penché haltères', sets: 3, reps: 10, rest: 60 },
          { name: 'Curl marteau', sets: 3, reps: 12, rest: 45 },
          { name: 'Pull-over', sets: 3, reps: 12, rest: 45 },
          { name: 'Pont fessier avec haltère', sets: 3, reps: 12, rest: 45 },
        ],
      },
      {
        id: '2-d',
        name: 'Jour 4 - Jambes & stabilisation',
        focus: 'Bas du corps et gainage',
        duration: 35,
        exercises: [
          { name: 'Squat bulgare', sets: 3, reps: 10, rest: 60 },
          { name: 'Soulevé de terre unilatéral', sets: 3, reps: 10, rest: 60 },
          { name: 'Reverse lunge haltères', sets: 3, reps: 12, rest: 60 },
          { name: 'Planche dynamique', sets: 3, reps: 30, rest: 45 },
          { name: 'Russian twist avec haltère', sets: 3, reps: 20, rest: 45 },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    level: 'Avancé',
    equipment: 'Barres',
    bodyParts: ['Force', 'Dos', 'Jambes'],
    description: 'Programme axé sur la progression en barre olympique et charges lourdes.',
    exercises: 28,
    color: 'from-indigo-500 to-indigo-600',
    goals: ['Force', 'Puissance'],
    sessionsPerWeek: 4,
    sessions: [
      {
        id: '8-a',
        name: 'Jour 1 - Squat & puissance',
        focus: 'Force des jambes',
        duration: 50,
        exercises: [
          { name: 'Back squat', sets: 5, reps: 5, rest: 120 },
          { name: 'Front squat', sets: 4, reps: 6, rest: 90 },
          { name: 'Good morning barre', sets: 3, reps: 8, rest: 90 },
          { name: 'Hip thrust barre', sets: 3, reps: 10, rest: 75 },
          { name: 'Mollets debout barre', sets: 3, reps: 15, rest: 60 },
        ],
      },
      {
        id: '8-b',
        name: 'Jour 2 - Poussée lourde',
        focus: 'Haut du corps',
        duration: 45,
        exercises: [
          { name: 'Développé couché barre', sets: 5, reps: 5, rest: 120 },
          { name: 'Développé militaire barre', sets: 4, reps: 6, rest: 90 },
          { name: 'Développé incliné barre', sets: 3, reps: 8, rest: 90 },
          { name: 'Dips lestés', sets: 3, reps: 8, rest: 60 },
          { name: 'Roll-out barre', sets: 3, reps: 12, rest: 60 },
        ],
      },
      {
        id: '8-c',
        name: 'Jour 3 - Tirage & base postérieure',
        focus: 'Dos & chaîne postérieure',
        duration: 45,
        exercises: [
          { name: 'Soulevé de terre classique', sets: 5, reps: 5, rest: 120 },
          { name: 'Pendlay row', sets: 4, reps: 6, rest: 90 },
          { name: 'Tirage menton barre', sets: 3, reps: 8, rest: 75 },
          { name: 'Shrug barre', sets: 3, reps: 12, rest: 60 },
          { name: 'Extensions lombaires barre', sets: 3, reps: 12, rest: 75 },
        ],
      },
      {
        id: '8-d',
        name: 'Jour 4 - Hypertrophie & gainage',
        focus: 'Volume contrôlé',
        duration: 40,
        exercises: [
          { name: 'Romanian deadlift', sets: 4, reps: 8, rest: 90 },
          { name: 'Barbell lunges', sets: 3, reps: 10, rest: 75 },
          { name: 'Floor press barre', sets: 3, reps: 10, rest: 75 },
          { name: 'Barbell hip thrust', sets: 3, reps: 12, rest: 60 },
          { name: 'Farmer carry barre', sets: 3, reps: 40, rest: 45 },
        ],
      },
    ],
  },
